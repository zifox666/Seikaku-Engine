...
- [第一阶段](./src/calculate/pass_1.rs)：收集舰体和模块的全部 Dogma 属性基础值。
- [第二阶段](./src/calculate/pass_2.rs)：收集舰体和模块的全部 Dogma 效果。
- [第三阶段](./src/calculate/pass_3.rs)：将所有 Dogma 效果应用到舰体/模块，计算最终属性值。
